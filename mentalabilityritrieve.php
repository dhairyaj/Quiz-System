<?php
    ...
    $query = 'SELECT * FROM MentalAbilityQuestions Order by rand() limit 10';
...
<html>
<head>
	<title>Mental Ability Quiz</title>
...
<body>
	<div class="navbar">
	<a class="subject">Subject: Mental Ability</a>
	    <div id="quiz-time-left"></div>
	</div>
	<form id="myform" method="post" name="quiz">
			<?php
				$i = 1;
				foreach($data as $row)
				{
